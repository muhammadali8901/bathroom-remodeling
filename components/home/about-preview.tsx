        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className={`relative transition-opacity duration-700 ${isInView ? 'opacity-100' : 'opacity-0'}`}>
            <div className="relative aspect-[4/3] rounded-2xl overflow-hidden">
              <Image
                ...
                alt="Gilbert Bath & Kitchen team at work - best bathroom remodel company near me"
                fill
          ...
          <div className={`pt-12 lg:pt-0 transition-opacity duration-700 ${isInView ? 'opacity-100' : 'opacity-0'}`}>
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-6">
              Gilbert Bath & Kitchen was founded with a simple mission: to transform ordinary 
              spaces into extraordinary ones. What started as a small family business has 
              grown into Gilbert&apos;s most trusted remodeling company and the best bathroom remodelers near me.
            </p>
