...
const KitchenSection = dynamic(() => import("@/components/home/kitchen-section"), { 
  loading: () => <div className="h-96" />,
  ssr: true 
});
...
const homeFaqs = [
  ...
  },
  {
    ...
    answer:
      "Yes! Gilbert Bath & Kitchen is consistently rated as the best bathroom remodelers near me. We offer complimentary in-home consultations where our design experts will assess your space and provide a detailed estimate.",
  },
  {
    question: "Are you licensed and insured for remodeling work in Arizona?",
    answer:
      "Absolutely. Gilbert Bath & Kitchen is fully licensed (ROC #123456), bonded, and insured for residential remodeling in Arizona. We are proud to be the best bathroom remodel company near me.",
  },
];
